...
# 모든 포스트의 셀렉터 값을 추출합니다.dl
post_selectors = driver.find_elements(By.CSS_SELECTOR, "[id^='post-']")

# 추출한 셀렉터 값을 출력하고 콤마로 구분하여 모은 결과를 출력합니다.
post_numbers = []
...
# 콤마로 구분한 포스트 번호들을 출력합니다.
post_numbers_string = ", ".join(post_numbers)
print(f"모든 포스트 번호: {post_numbers_string}")
